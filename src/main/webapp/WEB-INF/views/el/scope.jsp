...
<body>
    ...
    <pre>
    	...
    	****************** 내장 객체의 우선 순위 ************************
    	...
    	-> setAttribute("key", value)로 내장 객테가 값을 세팅할 때
    		key 값이 중복되는 경우
    		
    		\${key}로 작성하는 경우
    		범위가 작은 내장 객테가 높은 우선 순위를 갖게 된다.
    ...
    <h3>page의 str 값: ${requestScope.str}</h3>
    
    <h3>page의 str 값: ${sessionScope.str}</h3>
    
    <h3>page의 str 값: ${applicationScope.str}</h3>
