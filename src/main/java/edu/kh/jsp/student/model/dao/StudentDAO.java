...
public class StudentDAO {
	...
	public StudentDAO() {
		try {
			String filePath = StudentDAO.class.getResource("/edu/kh/jsp/edu.kh.jsp.sql/student-sql.xml").getPath();
	...
	public List<Student> deptSearch(Connection conn, String search) throws Exception {
		// 결과 저장용 변수 선언
